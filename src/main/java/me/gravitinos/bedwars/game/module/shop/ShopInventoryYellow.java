...
public class ShopInventoryYellow extends ShopInventory{

    public ShopInventoryYellow(ModuleGameItems gameItems){
        ...
        //Team Dependant
        this.addShopItem(new ShopItem(new ItemBuilder(gameItems.getGameItem(BedwarsItem.RESOURCE_IRON.toString()).getItem(1)).setAmount(3).build(), new ItemBuilder(Material.WOOL, 8, (byte) 4).build()));
