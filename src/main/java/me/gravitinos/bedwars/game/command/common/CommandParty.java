package me.gravitinos.bedwars.game.command.common;

import me.gravitinos.bedwars.game.command.GravCommand;
...
public class CommandParty extends GravCommand {
    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] args) {
        ...
        CoreHandler.instance.getAsyncExecutor().execute(() -> {
            ...
            if(!PartyComm.instance.loaded.contains(((Player) sender).getUniqueId())){
                this.sendErrorMessage(sender, BungeePartyFactory.PREFIX + "Your party hasn't finished loading, try again in a few seconds");
                return;
            }
