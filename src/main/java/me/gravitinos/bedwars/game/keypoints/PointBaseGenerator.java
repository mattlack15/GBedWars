...
public class PointBaseGenerator extends MapKeyPoint {
    public PointBaseGenerator(@NotNull Consumer<Location> locationConsumer) {
        super("MID_GENERATOR", locationConsumer, new MapBlockIdentity(Material.BEDROCK, 0));
        this.addIdentifyingPoint(new Vector(0,1,0), new MapBlockIdentity(Material.SIGN_POST,-1, "BASE_GEN"));
    }
}
