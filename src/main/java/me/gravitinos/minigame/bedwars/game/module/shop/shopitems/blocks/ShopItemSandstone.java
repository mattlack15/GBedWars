...
public class ShopItemSandstone extends ShopItemData {

    private static final BedwarsItem COST_RESOURCE = BedwarsItem.RESOURCE_IRON;
    private static final int COST_AMOUNT = 10;

    private static final int GIVE_AMOUNT = 6;
    private static final Material GIVE_MATERIAL = Material.SANDSTONE;
