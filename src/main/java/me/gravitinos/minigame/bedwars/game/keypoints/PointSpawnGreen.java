...
public class PointSpawnGreen extends MapKeyPoint {
    public PointSpawnGreen(@NotNull Consumer<Location> locationConsumer) {
        super("SPAWN_GREEN", locationConsumer, new MapBlockIdentity(Material.WOOL.getId(), 5));
