...
public class PartyMessageSetLeader implements MessageAgent {

    private UUID partyId;
    private UUID player;

    public PartyMessageSetLeader(UUID partyId, UUID player){
    ...
    public String getSubChannel() {
        return PartyMessageIdentifier.SUB_SETLEADER;
    }
